...
public class Fbo {
	...
	private boolean multisampleAndMuliTarget = false;
	...
	public Fbo(int width, int height) {
		this.width = width;
		this.height = height;
		this.multisampleAndMuliTarget = true;
	...
	private void initialiseFrameBuffer(int type) {
		createFrameBuffer();
		if(multisampleAndMuliTarget){
			colourBuffer = createMultisampleColurAttachment(GL30.GL_COLOR_ATTACHMENT0);
			colourBuffer2 = createMultisampleColurAttachment(GL30.GL_COLOR_ATTACHMENT1);
		}else{
	...
	private void determineDrawBuffers(){
		...
		if(this.multisampleAndMuliTarget){
	...
	private int createMultisampleColurAttachment(int attachment){
