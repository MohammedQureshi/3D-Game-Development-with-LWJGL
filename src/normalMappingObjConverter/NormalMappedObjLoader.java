...
public class NormalMappedObjLoader {
	...
	//private static final String RES_LOC = "res/normalMap/";

	public static RawModel loadOBJ(String objFileName, Loader loader) {
		InputStreamReader isr = new InputStreamReader(Class.class.getResourceAsStream("/res/normalMap/"+objFileName+".obj"));
